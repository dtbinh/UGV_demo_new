...
from sml_modules.vehicle_models import RandomDestinationVehicle, ConnectivityVehicle
...
def vehicle(vehicle_id, vehicle_class, x=0., y=0., yaw=0., speed_in_ms=0.):
    ...
    if vehicle_class == BaseVehicle.__name__:
        BaseVehicle(rospy.get_namespace(), vehicle_id, 20,
                    x, y, yaw, speed_in_ms)
    elif vehicle_class == TruckVehicle.__name__:
        TruckVehicle(rospy.get_namespace(), vehicle_id, 20,
                    x, y, yaw, speed_in_ms)
        ...
        BusVehicle(rospy.get_namespace(), vehicle_id, 20,
                    x, y, yaw, speed_in_ms)
    elif vehicle_class == RandomDestinationVehicle.__name__:
        RandomDestinationVehicle(rospy.get_namespace(), vehicle_id, 20,
                    x, y, yaw, speed_in_ms)
    elif vehicle_class == ConnectivityVehicle.__name__:
        ConnectivityVehicle(rospy.get_namespace(), vehicle_id, 20,
                    x, y, yaw, speed_in_ms)
    elif vehicle_class == SemiControlledVehicle.__name__:
        SemiControlledVehicle(rospy.get_namespace(), vehicle_id, 20,
                    x, y, yaw, speed_in_ms)
    else:
