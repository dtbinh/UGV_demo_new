...
class Radar(BaseSensor):
    ...
    def __init__(self, vehicle_id, name, sens_range, sens_angle, offset=0):
        """
        ...
        @param offset: I{(float)} Angle offset to vehicle's direction sensor
                    should be placed
        """
        ...
        self.offset_rad = float(offset) * np.pi/180
