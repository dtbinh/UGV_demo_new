def lanelet_dijkstra_algorithm(road_module, source_lanelet_id, destination_lanelet_id, traffic_data):
    '''
    ...
    Inputs:
        ...
        traffic_data:
        Traffic information dictionary for the lanelets.
    ...
    lanelet_indexes_path = dijkstra_algorithm(road_module.lanelet_adjacency_matrix, source_lanelet_index, destination_lanelet_index, traffic_data)
...
def dijkstra_algorithm(adjacency_matrix, source_index, destination_index = None, weight_dict = None):
    '''
    ...
    while nodes_to_visit:
        ...
        for i in range( len(current_adjacencies) ):
            ...
            if weight_dict:
                distance_to_node = current_adjacencies[i] * weight_dict[i]
            else:
                distance_to_node = current_adjacencies[i] 

            if distances[i] >  distances[current_node_to_visit] + distance_to_node:

                distances[i] = distances[current_node_to_visit] + distance_to_node
...
def lanelet_circular_dijkstra_algorithm(road_module, source_lanelet_id, traffic_data):
    '''
    ...
    lanelet_indexes_path = circular_dijkstra_algorithm(road_module.lanelet_adjacency_matrix, source_lanelet_index, traffic_data)
...
def circular_dijkstra_algorithm(adjacency_matrix, source_index, weight_dict = None):
    '''
